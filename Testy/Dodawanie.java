...
public class Dodawanie {
  ...
  public void testDodawanie() throws Exception {
    ...
    driver.findElement(By.id("id_last_name")).sendKeys("Nowakowski");
    driver.findElement(By.id("id_login")).clear();
    driver.findElement(By.id("id_login")).sendKeys("anowakowski");
    driver.findElement(By.id("id_password")).clear();
    driver.findElement(By.id("id_password")).sendKeys("anowakowski1234");
    driver.findElement(By.id("id_email")).clear();
    driver.findElement(By.id("id_email")).sendKeys("anowakowski@agh.edu.pl");
    driver.findElement(By.xpath("//input[@value='Save']")).click();
    driver.findElement(By.xpath("//button[@type='button']")).click();
    driver.findElement(By.linkText("Logout")).click();
    assertEquals("anowakowski", driver.findElement(By.id("id_login")).getAttribute("value"));
